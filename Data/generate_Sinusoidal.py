"""
Originally got this from Ben Ren's github: https://github.com/BensonRen/BDIMNNA
...
x_low = -1
x_high = 1
#num_sample_dimension = 100 # use this for the *training* data -- 10000 points
num_sample_dimension = 32 # use for the *testing* data -- 1024 points
f = 3
...
if __name__ == '__main__':
    ...
    np.savetxt(os.path.join(save_dir, 'data_x.csv'), data_x, delimiter=',')
    np.savetxt(os.path.join(save_dir, 'data_y.csv'), data_y, delimiter=',')
